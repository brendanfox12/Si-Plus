...
This analysis will specifically focus on the isometric force produced by the human upper limb at various angles. The questions that we will aim to answer are: (1) Do class-wide force-angle data for isometric MVC accord to a typical FL relationship both under control and fatigued conditions? (2) Is there a significant shift between θmax between the control and fatigue FL relationships? By analyzing class-wide force-angle data, this will allow for comparison of the different angles at which maximum isometric force occurs in different fatigue intensities. This permits for further discussion on the underlying mechanisms that result at times of fatigue. 
